...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'List all users (optionally filter by role)' }),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Create a user with any role (only way to make an ADMIN)' }),
    (0, common_1.Post)(),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Update a user (role, details, password)' }),
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
